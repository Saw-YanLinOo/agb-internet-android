...
import com.agb.billing.customer.adapter.ChargesAdapter
import com.agb.billing.customer.databinding.ActivityInvoiceDetailBinding
import com.agb.billing.customer.delegate.AYAPaymentInfoDelegate
import com.agb.billing.customer.delegate.PaymentTypeDelegate
import com.agb.billing.customer.dialog.AYAPaymentSuccessAndErrorDialog
import com.agb.billing.customer.dialog.PaymentInformationDialog
...
import com.agb.billing.customer.viewmodels.InvoiceDetailViewModel
...
//        detailApiCall()
    ...
    private fun initViewModel() {
        mViewModel = ViewModelProvider(this).get(InvoiceDetailViewModel::class.java)
