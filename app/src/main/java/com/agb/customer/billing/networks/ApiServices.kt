...
import com.agb.customer.billing.networks.EndPoints.ACTIVE_PLAN_URL
import com.agb.customer.billing.networks.EndPoints.CANCEL_PLAN
import com.agb.customer.billing.networks.EndPoints.CB_PAYMENT_DOWNLOAD_QR
import com.agb.customer.billing.networks.EndPoints.CHANGE_PLAN
import com.agb.customer.billing.networks.EndPoints.CHANGE_PLAN_PRELOAD
import com.agb.customer.billing.networks.EndPoints.COMPLAIN_PRELOAD_URL
import com.agb.customer.billing.networks.EndPoints.HOME_URL
import com.agb.customer.billing.networks.EndPoints.INVOICE_DETAIL
import com.agb.customer.billing.networks.EndPoints.INVOICE_LIST_URL
import com.agb.customer.billing.networks.EndPoints.PAYMENT_URL
import retrofit2.Call
import retrofit2.http.Body
import retrofit2.http.POST
import com.agb.customer.billing.networks.EndPoints.LOGIN_URL
import com.agb.customer.billing.networks.EndPoints.LOGOUT_URL
import com.agb.customer.billing.networks.EndPoints.NOTIFICATION_URL
import com.agb.customer.billing.networks.EndPoints.PAYMENT_METHOD
import com.agb.customer.billing.networks.EndPoints.PENDING_PLAN_URL
import com.agb.customer.billing.networks.EndPoints.PLAN_BY_BANDWIDTH
import com.agb.customer.billing.networks.EndPoints.PROFILE_UPDATE_URL
import com.agb.customer.billing.networks.EndPoints.PROFILE_URL
import com.agb.customer.billing.networks.EndPoints.RECEIPT_LIST_URL
import com.agb.customer.billing.networks.EndPoints.RESET_PASSWORD
import com.agb.customer.billing.networks.EndPoints.SUPPORT
import com.agb.customer.billing.networks.EndPoints.TICKET_CREATE_URL
import com.agb.customer.billing.networks.EndPoints.TICKET_LIST_URL
...
interface ApiServices {
    ...
    fun getActivePlanList(@Body req: com.agb.customer.billing.networks.requests.PaginationRequest): Call<ActivePlanListResponse>

    @POST(PENDING_PLAN_URL)
    fun getPendingPlanList(@Body req: com.agb.customer.billing.networks.requests.PaginationRequest): Call<PendingPlanListResponse>
