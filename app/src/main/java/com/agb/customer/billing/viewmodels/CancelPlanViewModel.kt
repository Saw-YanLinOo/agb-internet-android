...
class CancelPlanViewModel : BaseViewModel() {

    //api call
    var myView: CancelPlanView?=null

    fun setView(mView: CancelPlanView){
        this.myView = mView
    }

    fun getCancelPlan(request : CancelPlanRequest){

        RestClient.getApiService().getCancelPlan(request)
                ...
                override fun onResponse(
                    ...
                    if (response.isSuccessful){
                        ...
                        when (mResponse.responseCode) {
                            ...
                            Constants.API_SUCCESS_CODE -> myView!!.setCancelPlan(mResponse)
