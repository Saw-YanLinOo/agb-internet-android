...
import com.agb.customer.billing.adapter.InvoiceAdapter
import com.agb.customer.billing.databinding.ActivityInvoicesBinding
...
import com.agb.customer.billing.viewmodels.InvoiceListViewModel
...
//            })
    ...
    private fun hideLoadingNetwork() {
        binding.apply {
            shimmerLoading.stopShimmer()
            shimmerLoading.visibility = View.GONE
            rvInvoices.visibility = View.INVISIBLE
